...
# analytics, event/project rollout logic, and the tiktoken-backed UniqueIdExperiment. The Parameterizer import is
# relative because this file lives in a pinned vendored package.

from itertools import islice

from ..parameterization import Parameterizer
